...
class SessionsPlotter:
    ...
    def plot_mean_ndcg_evolution(self, figsize=(20, 6)):
        plot_smooth_line(
    ...
    def plot_mean_avg_precision_evolution(self, figsize=(20, 6)):
        plot_smooth_line(
    ...
    def plot_mean_reciprocal_rank_evolution(self, figsize=(20, 6)):
        plot_smooth_line(
    ...
    def plot_mean_recall_evolution(self, figsize=(20, 6)):
        plot_smooth_line(
    ...
    def metrics(self, item_ids=[]):
        ...
        logging.info(
            f'User Sessions - Steps Count: {self.total_steps_count}'
        )
