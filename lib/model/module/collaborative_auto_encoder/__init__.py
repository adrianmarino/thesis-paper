from .collaborative_denoising_auto_encoder   import CollaborativeDenoisingAutoEncoder
...
from .collaborative_variational_auto_encoder import CollaborativeVariationalAutoEncoder
