...
\subsection{Ensample de KNN User Based y Item Based}
...
\clearpage
\section{GFM (General Matrix Factorization)}
...
\clearpage
\section{B-GFM (Biased General Matrix Factorization)}
...
\section{NN-FM (Neural Network Matrix Factorization)}
...
\section{DeepFM (Deep Factorization Machine)}
...
\begin{table}[!htb]
	...
	\hline
		Biased-GMF                   & 0.408563 & 0.408787 & 0.012190 \\
		GMF                          & 0.406422 & 0.406646 & 0.012513 \\
		Deep-FM                      & 0.398100 & 0.397895 & 0.011369 \\
...
\begin{table}[!htb]
	...
	\begin{tabular}{lrrr}
		...
		\hline
			...
			Biased-GMF                   & 0.977914 & 0.977382 & 0.009387 \\
			GMF                          & 0.983141 & 0.982894 & 0.009419 \\
			Deep-FM                      & 1.133796 & 1.133637 & 0.009183 \\
...
\item Nuevamente la familia de modelos KNN tiene los errores mas alto y también altos desvíos. Aun asi estos modelos tiene una precisión muy similar al modelo mas preciso (Biased-GMF).
\end{itemize}


\chapter{Conclusiones}

Como conclusiones, se puede decir que no se encuentra una gran diferencia en precisión entre todos modelos, siendo esta menor al 2 \%. Por otro lado, si tuviésemos que llevar alguno de esto modelos a producción e un e-commerce, claramente se elegiría un modelo basado en deep learning, como pueden ser Biased-GMF o GMF. Esto se debe a que estos modelos utilizan el algoritmo del gradiente descendente, pudiendo procesar las observaciones de entrenamiento en lotes. De esta forma, se puede seleccionar un tamaño de lote que se ajuste a la memoria RAM o VRAM disponible. Por lo contrario no seria posible selecciona modelos de la familia KNN debido a que necesitan alocar todas las observaciones den entrenamiento en memoria.
