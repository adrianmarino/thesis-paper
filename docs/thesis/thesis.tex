...
\begin{figure}[h!]
	...
	\caption{Diagrama Boxplot e Histograma de la variable ratting. Los ratings son las calificaciones realizadas por los usuario para cada item o película.}
\end{figure}
...
\begin{itemize}
	...
	\item La mediana(Cuantil Q2) esta claramente sobre los 4 puntos, coincidiendo con la moda. La media se encuentra en los 3.5 puntos a izquierda de la mediana, debido a que tenemos puntos con frecuencia considerables a izquierda que mueven a la mediana en esa dirección.
