...
modificación al modelo \textit{KNN} para poder guardarsus resultados en una
...
variabilidad o varianza desus predicciones, se realizo un muestreo $5.000$
inferencias para cada modelo sobre el conjunto de validación para cada métrica
utilizada. Luego, se gráfico un histograma de la distribución de la métricas, y
un boxplot para tener una mejor idea de cual es su valor medio y la dispersión
...
la familia de modelos \textit{KNN}: \textit{KNN User Based}, \textit{KNN Item
	Based} y un ensamble de ambos modelos.
