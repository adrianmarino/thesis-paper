...
\begin{table}[!htb]
	...
	\end{tabular}
	\caption{
		Columnas extraídas del \textit{dataset} \textit{Movie Lens}, relevantes para este trabajo practico.
	}
...
\begin{table}[!htb]
	...
	\end{tabular}
	\caption{
		Columnas extraídas del \textit{dataset} \textit{TMDB}, relevantes para este trabajo practico.
	}
