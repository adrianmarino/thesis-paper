...
En las figuras siguientes~\ref{fig:bGmfMap} y~\ref{fig:bGmfRMSE} apreciar el
comportamiento explicado anteriormente, donde la precisión aumenta de
$0.406646$ (\textit{B-GMF}) a $0.408787$ (\textit{B-GMF}) (diff: $0.002141$) y disminuje el desvio
levemente, de c (\textit{B-GMF}) (diff: $0.000323$).

La precisión~\ref{fig:bGmfMap} a simplebisca no parece tern sesgos,
