...
utilizados en los modelos de recomendación basados en \textit{Deep Learning}. 
A partir de este punto, se procederá a describir las arquitecturas utilizadas en este
trabajo.
...
se agrega un \textit{bias} o sesgo para los usuarios y otro para los ítems.
