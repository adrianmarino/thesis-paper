...
\begin{itemize}
	...
	\item Nuevamente vemos algo parecido en diagrama de barras, el 50\% de las observaciones se encuentran entre los cuantiles Q1 y Q3 con 3 y 4.5 puntos (Rango inter-cuantil).
...
\begin{itemize}
	...
	\item A simple vista, los clústeres(\textit{Embeddings}) que pudieran generarse utilizando esta variable, podrían ser mas específicos que aquellos clusters generados a partir de la variable tags.
\end{itemize}
