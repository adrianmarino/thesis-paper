...
\end{description}
\begin{itemize}
	\item Las palabra based (basada/o en..), \textit{{Book}, \textit{Bd}, \textit{Director}, \textit{Nudity}, \textit{Topless}, \textit{Indepedent}, \textit{Film}, son aquella palabras mas utilizadas en los tags que cargan los usuario para cada película.
...
De esta forms , los coeficientes define una media de correlación o grado de aporte de cada variable origina a componente principal.

A continuación se pueden visualizar lo loading o cargas:

\begin{center}
	\includegraphics[width=15cm]{./images/PCA-Loadings.png}
\end{center}
\begin{description}
	\item[Observaciones]
\end{description}
...
Entonces si pasamos el valores \textbf{Nublado} como entrada a la capa, en realidad estamos pasando la clave 0. Luego, de esto la capa resuelve el vector embedding asociado a esa clave y lo devuelve a su salida.
